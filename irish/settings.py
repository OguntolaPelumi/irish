"""
Django settings for irish project.
...
SECRET_KEY = "django-insecure-@1qpz2$k@v0yc2(tvppzru($tbt^iwy2+pulx+85mc2$!s0p9i"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["irishroverinc.onrender.com", "localhost", "127.0.0.1", 
...
WSGI_APPLICATION = "irish.wsgi.application"
